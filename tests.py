...
class TestBooksCollector:
    ...
    def test_cant_rate_less_one(self, collector, add_book_of_zombie, book_of_zombie):
    ...
    @pytest.mark.parametrize('book_rate', ['Гордость и предубеждение и зомби', 'Гордость и предубеждение и зомби'])
    def test_cant_rate_more_ten(self, collector, add_book_of_zombie, book_rate):
        collector.set_book_rating(book_rate, 11)
        collector.set_book_rating(book_rate, 10)
        assert collector.get_book_rating(
            'Гордость и предубеждение и зомби') == 10, "Можно установить рейтинг книги больше 10"

    def test_absent_book_has_no_rating(self, collector, add_book_of_war, book_of_war):
    ...
    def test_add_book_to_favorites(self, collector, add_book_of_zombie, book_of_zombie):
    ...
    def test_get_books_with_specific_rating(self, collector,add_book_of_zombie, add_book_of_cat, add_book_of_fight, book_of_zombie, book_of_cat, book_of_fight):
        collector.set_book_rating(book_of_zombie, 1)
    ...
    def test_set_book_rating(self, collector, add_book_of_war, book_of_war):
