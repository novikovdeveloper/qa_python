...
class TestBooksCollector:
    ...
    def test_cant_rate_less_one(self):
        ...
        assert books_rate.books_rating != {'Гордость и предубеждение и зомби', 0}
    ...
    def test_remove_book_from_favorites(self):
        ...
        none_lst = del_book.delete_book_from_favorites('Гордость и предубеждение и зомби')
        assert none_lst is None
